          ...
          <div class="col form-col register">
            ...
            <form name='myForm' id='myForm' className='login-form' method="post">
              ...
              <div>
                ...
                <br />
                <input id='first-name' name='first-name' type="text" minlength="3" placeholder="Etunimi" autocomplete="off" required />
                <p id="fname-field"></p>
              </div>
              ...
              <div>
                ...
                <br />
                <input id='last-name' name='last-name' type="text" minlength="3" placeholder="Sukunimi" autocomplete="off" required />
                <p id="lname-field"></p>
              </div>
