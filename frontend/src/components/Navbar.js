...
export default function Navbar() {
  return (
    <>
      ...
      <div className="container-fluid navbar-container justify-content-center">
        <header className="d-flex flex-wrap py-3">
          ...
          <ul className="nav nav-pills">
            ...
            <li className="nav-item me-2 dropdown">
              <a className="nav-link dropdown-toggle" href="/shoppingcart" id="navbarDropdownMenuLink" role="button" data-bs-toggle="dropdown" aria-expanded="false">
